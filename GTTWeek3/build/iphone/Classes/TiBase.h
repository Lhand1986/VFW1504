...
// in simulator we redefine to format for GTTWeek3 Developer console
...
{\
	NSString * exceptionName = [@"org.gttweek3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gttweek3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGTTWeek3NativeItemNone = -1, 
	UIGTTWeek3NativeItemSpinner = -2,
	UIGTTWeek3NativeItemProgressBar = -3,
	
	UIGTTWeek3NativeItemSlider = -4,
	UIGTTWeek3NativeItemSwitch = -5,
	UIGTTWeek3NativeItemMultiButton = -6,
	UIGTTWeek3NativeItemSegmented = -7,
	
	UIGTTWeek3NativeItemTextView = -8,
	UIGTTWeek3NativeItemTextField = -9,
	UIGTTWeek3NativeItemSearchBar = -10,
	
	UIGTTWeek3NativeItemPicker = -11,
	UIGTTWeek3NativeItemDatePicker = -12,
	
	UIGTTWeek3NativeItemInfoLight = -13,
	UIGTTWeek3NativeItemInfoDark = -14,
	
	UIGTTWeek3NativeItemDisclosure = -15,
	
	UIGTTWeek3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GTTWeek3 instances of
