...
/**
 The base class for all GTTWeek3 modules
 */
...
/**
 GTTWeek3 Platform calls this method on startup.
 */
-(void)startup;

/**
 GTTWeek3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 GTTWeek3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 GTTWeek3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 GTTWeek3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
