...
//@interface GTTWeek3Object : NSObject
//@end

@interface GTTWeek3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GTTWeek3Object class]])
		{
			for (NSString *key in [[(GTTWeek3Object*)o modules] allKeys])
			{
