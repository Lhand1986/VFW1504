...
// in simulator we redefine to format for Hand_Levi_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.hand_levi_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hand_levi_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHand_Levi_Project3NativeItemNone = -1, 
	UIHand_Levi_Project3NativeItemSpinner = -2,
	UIHand_Levi_Project3NativeItemProgressBar = -3,
	
	UIHand_Levi_Project3NativeItemSlider = -4,
	UIHand_Levi_Project3NativeItemSwitch = -5,
	UIHand_Levi_Project3NativeItemMultiButton = -6,
	UIHand_Levi_Project3NativeItemSegmented = -7,
	
	UIHand_Levi_Project3NativeItemTextView = -8,
	UIHand_Levi_Project3NativeItemTextField = -9,
	UIHand_Levi_Project3NativeItemSearchBar = -10,
	
	UIHand_Levi_Project3NativeItemPicker = -11,
	UIHand_Levi_Project3NativeItemDatePicker = -12,
	
	UIHand_Levi_Project3NativeItemInfoLight = -13,
	UIHand_Levi_Project3NativeItemInfoDark = -14,
	
	UIHand_Levi_Project3NativeItemDisclosure = -15,
	
	UIHand_Levi_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hand_Levi_Project3 instances of
