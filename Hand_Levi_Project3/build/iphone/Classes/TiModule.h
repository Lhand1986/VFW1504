...
/**
 The base class for all Hand_Levi_Project3 modules
 */
...
/**
 Hand_Levi_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Hand_Levi_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Hand_Levi_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Hand_Levi_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Hand_Levi_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
