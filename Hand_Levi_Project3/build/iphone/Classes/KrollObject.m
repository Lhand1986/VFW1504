...
//@interface Hand_Levi_Project3Object : NSObject
//@end

@interface Hand_Levi_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hand_Levi_Project3Object class]])
		{
			for (NSString *key in [[(Hand_Levi_Project3Object*)o modules] allKeys])
			{
