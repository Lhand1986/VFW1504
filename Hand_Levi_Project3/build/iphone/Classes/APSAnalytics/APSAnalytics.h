 ...
 * to send analytic data that can be viewed on the Hand_Levi_Project3 Dashboard.
 *
 * For information on getting started with Hand_Levi_Project3 Platform Services,
