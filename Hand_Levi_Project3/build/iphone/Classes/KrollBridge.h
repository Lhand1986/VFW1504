...
@interface Hand_Levi_Project3Object : KrollCoverageObject {
#else
@interface Hand_Levi_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Hand_Levi_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hand_Levi_Project3Object *_hand_levi_project3;
    KrollObject* console;
	BOOL shutdown;
