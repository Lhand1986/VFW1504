...
@interface GTT_Week_4Object : KrollCoverageObject {
#else
@interface GTT_Week_4Object : KrollObject {
#endif
@private
...
extern NSString * GTT_Week_4$ModuleRequireFormat;
