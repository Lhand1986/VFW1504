...
// in simulator we redefine to format for GTT_Week_4 Developer console
...
{\
	NSString * exceptionName = [@"org.gtt_week_4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gtt_week_4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGTT_Week_4NativeItemNone = -1, 
	UIGTT_Week_4NativeItemSpinner = -2,
	UIGTT_Week_4NativeItemProgressBar = -3,
	
	UIGTT_Week_4NativeItemSlider = -4,
	UIGTT_Week_4NativeItemSwitch = -5,
	UIGTT_Week_4NativeItemMultiButton = -6,
	UIGTT_Week_4NativeItemSegmented = -7,
	
	UIGTT_Week_4NativeItemTextView = -8,
	UIGTT_Week_4NativeItemTextField = -9,
	UIGTT_Week_4NativeItemSearchBar = -10,
	
	UIGTT_Week_4NativeItemPicker = -11,
	UIGTT_Week_4NativeItemDatePicker = -12,
	
	UIGTT_Week_4NativeItemInfoLight = -13,
	UIGTT_Week_4NativeItemInfoDark = -14,
	
	UIGTT_Week_4NativeItemDisclosure = -15,
	
	UIGTT_Week_4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GTT_Week_4 instances of
