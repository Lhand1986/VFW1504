...
//@interface GTT_Week_4Object : NSObject
//@end

@interface GTT_Week_4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GTT_Week_4Object class]])
		{
			for (NSString *key in [[(GTT_Week_4Object*)o modules] allKeys])
			{
