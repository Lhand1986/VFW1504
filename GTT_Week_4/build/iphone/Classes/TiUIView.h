...
/**
 Base class for all GTT_Week_4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GTT_Week_4 view hierarchy (such as wrapped iOS UIViews) was touched.
