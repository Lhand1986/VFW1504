...
//Rare exceptions to indicate a bug in the _hand_levi_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Hand_Levi_Project1 proxies.
 */
