...
@interface Hand_Levi_Project1Object : KrollCoverageObject {
#else
@interface Hand_Levi_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Hand_Levi_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hand_Levi_Project1Object *_hand_levi_project1;
    KrollObject* console;
	BOOL shutdown;
