...
// in simulator we redefine to format for Hand_Levi_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.hand_levi_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hand_levi_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHand_Levi_Project1NativeItemNone = -1, 
	UIHand_Levi_Project1NativeItemSpinner = -2,
	UIHand_Levi_Project1NativeItemProgressBar = -3,
	
	UIHand_Levi_Project1NativeItemSlider = -4,
	UIHand_Levi_Project1NativeItemSwitch = -5,
	UIHand_Levi_Project1NativeItemMultiButton = -6,
	UIHand_Levi_Project1NativeItemSegmented = -7,
	
	UIHand_Levi_Project1NativeItemTextView = -8,
	UIHand_Levi_Project1NativeItemTextField = -9,
	UIHand_Levi_Project1NativeItemSearchBar = -10,
	
	UIHand_Levi_Project1NativeItemPicker = -11,
	UIHand_Levi_Project1NativeItemDatePicker = -12,
	
	UIHand_Levi_Project1NativeItemInfoLight = -13,
	UIHand_Levi_Project1NativeItemInfoDark = -14,
	
	UIHand_Levi_Project1NativeItemDisclosure = -15,
	
	UIHand_Levi_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hand_Levi_Project1 instances of
