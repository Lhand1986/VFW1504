...
//@interface Hand_Levi_Project1Object : NSObject
//@end

@interface Hand_Levi_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hand_Levi_Project1Object class]])
		{
			for (NSString *key in [[(Hand_Levi_Project1Object*)o modules] allKeys])
			{
