...
//@interface Hand_Levi_Project4Object : NSObject
//@end

@interface Hand_Levi_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hand_Levi_Project4Object class]])
		{
			for (NSString *key in [[(Hand_Levi_Project4Object*)o modules] allKeys])
			{
