...
@interface Hand_Levi_Project4Object : KrollCoverageObject {
#else
@interface Hand_Levi_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Hand_Levi_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hand_Levi_Project4Object *_hand_levi_project4;
    KrollObject* console;
	BOOL shutdown;
