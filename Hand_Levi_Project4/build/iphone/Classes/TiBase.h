...
// in simulator we redefine to format for Hand_Levi_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.hand_levi_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hand_levi_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHand_Levi_Project4NativeItemNone = -1, 
	UIHand_Levi_Project4NativeItemSpinner = -2,
	UIHand_Levi_Project4NativeItemProgressBar = -3,
	
	UIHand_Levi_Project4NativeItemSlider = -4,
	UIHand_Levi_Project4NativeItemSwitch = -5,
	UIHand_Levi_Project4NativeItemMultiButton = -6,
	UIHand_Levi_Project4NativeItemSegmented = -7,
	
	UIHand_Levi_Project4NativeItemTextView = -8,
	UIHand_Levi_Project4NativeItemTextField = -9,
	UIHand_Levi_Project4NativeItemSearchBar = -10,
	
	UIHand_Levi_Project4NativeItemPicker = -11,
	UIHand_Levi_Project4NativeItemDatePicker = -12,
	
	UIHand_Levi_Project4NativeItemInfoLight = -13,
	UIHand_Levi_Project4NativeItemInfoDark = -14,
	
	UIHand_Levi_Project4NativeItemDisclosure = -15,
	
	UIHand_Levi_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hand_Levi_Project4 instances of
