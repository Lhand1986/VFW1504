...
// in simulator we redefine to format for Week_2_Examples Developer console
...
{\
	NSString * exceptionName = [@"org.week_2_examples." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week_2_examples";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek_2_ExamplesNativeItemNone = -1, 
	UIWeek_2_ExamplesNativeItemSpinner = -2,
	UIWeek_2_ExamplesNativeItemProgressBar = -3,
	
	UIWeek_2_ExamplesNativeItemSlider = -4,
	UIWeek_2_ExamplesNativeItemSwitch = -5,
	UIWeek_2_ExamplesNativeItemMultiButton = -6,
	UIWeek_2_ExamplesNativeItemSegmented = -7,
	
	UIWeek_2_ExamplesNativeItemTextView = -8,
	UIWeek_2_ExamplesNativeItemTextField = -9,
	UIWeek_2_ExamplesNativeItemSearchBar = -10,
	
	UIWeek_2_ExamplesNativeItemPicker = -11,
	UIWeek_2_ExamplesNativeItemDatePicker = -12,
	
	UIWeek_2_ExamplesNativeItemInfoLight = -13,
	UIWeek_2_ExamplesNativeItemInfoDark = -14,
	
	UIWeek_2_ExamplesNativeItemDisclosure = -15,
	
	UIWeek_2_ExamplesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week_2_Examples instances of
