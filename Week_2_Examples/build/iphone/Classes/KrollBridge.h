...
@interface Week_2_ExamplesObject : KrollCoverageObject {
#else
@interface Week_2_ExamplesObject : KrollObject {
#endif
@private
...
extern NSString * Week_2_Examples$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week_2_ExamplesObject *_week_2_examples;
    KrollObject* console;
	BOOL shutdown;
