...
//Rare exceptions to indicate a bug in the _week_2_examples code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Week_2_Examples proxies.
 */
