...
//@interface Week_2_ExamplesObject : NSObject
//@end

@interface Week_2_ExamplesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week_2_ExamplesObject class]])
		{
			for (NSString *key in [[(Week_2_ExamplesObject*)o modules] allKeys])
			{
