...
//@interface Week_3_ExamplesObject : NSObject
//@end

@interface Week_3_ExamplesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week_3_ExamplesObject class]])
		{
			for (NSString *key in [[(Week_3_ExamplesObject*)o modules] allKeys])
			{
