...
/**
 Base class for all Week_3_Examples views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week_3_Examples view hierarchy (such as wrapped iOS UIViews) was touched.
