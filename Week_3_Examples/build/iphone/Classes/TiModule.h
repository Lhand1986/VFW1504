...
/**
 The base class for all Week_3_Examples modules
 */
...
/**
 Week_3_Examples Platform calls this method on startup.
 */
-(void)startup;

/**
 Week_3_Examples Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Week_3_Examples Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Week_3_Examples Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Week_3_Examples Platform calls this method on resume.
 @param sender The sender of the event.
 */
