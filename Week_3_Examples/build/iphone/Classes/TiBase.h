...
// in simulator we redefine to format for Week_3_Examples Developer console
...
{\
	NSString * exceptionName = [@"org.week_3_examples." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week_3_examples";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek_3_ExamplesNativeItemNone = -1, 
	UIWeek_3_ExamplesNativeItemSpinner = -2,
	UIWeek_3_ExamplesNativeItemProgressBar = -3,
	
	UIWeek_3_ExamplesNativeItemSlider = -4,
	UIWeek_3_ExamplesNativeItemSwitch = -5,
	UIWeek_3_ExamplesNativeItemMultiButton = -6,
	UIWeek_3_ExamplesNativeItemSegmented = -7,
	
	UIWeek_3_ExamplesNativeItemTextView = -8,
	UIWeek_3_ExamplesNativeItemTextField = -9,
	UIWeek_3_ExamplesNativeItemSearchBar = -10,
	
	UIWeek_3_ExamplesNativeItemPicker = -11,
	UIWeek_3_ExamplesNativeItemDatePicker = -12,
	
	UIWeek_3_ExamplesNativeItemInfoLight = -13,
	UIWeek_3_ExamplesNativeItemInfoDark = -14,
	
	UIWeek_3_ExamplesNativeItemDisclosure = -15,
	
	UIWeek_3_ExamplesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week_3_Examples instances of
