...
@interface Week_3_ExamplesObject : KrollCoverageObject {
#else
@interface Week_3_ExamplesObject : KrollObject {
#endif
@private
...
extern NSString * Week_3_Examples$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week_3_ExamplesObject *_week_3_examples;
    KrollObject* console;
	BOOL shutdown;
