...
// in simulator we redefine to format for Week_3_Examples_imageLayout Developer console
...
{\
	NSString * exceptionName = [@"org.week_3_examples_imagelayout." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week_3_examples_imagelayout";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek_3_Examples_imageLayoutNativeItemNone = -1, 
	UIWeek_3_Examples_imageLayoutNativeItemSpinner = -2,
	UIWeek_3_Examples_imageLayoutNativeItemProgressBar = -3,
	
	UIWeek_3_Examples_imageLayoutNativeItemSlider = -4,
	UIWeek_3_Examples_imageLayoutNativeItemSwitch = -5,
	UIWeek_3_Examples_imageLayoutNativeItemMultiButton = -6,
	UIWeek_3_Examples_imageLayoutNativeItemSegmented = -7,
	
	UIWeek_3_Examples_imageLayoutNativeItemTextView = -8,
	UIWeek_3_Examples_imageLayoutNativeItemTextField = -9,
	UIWeek_3_Examples_imageLayoutNativeItemSearchBar = -10,
	
	UIWeek_3_Examples_imageLayoutNativeItemPicker = -11,
	UIWeek_3_Examples_imageLayoutNativeItemDatePicker = -12,
	
	UIWeek_3_Examples_imageLayoutNativeItemInfoLight = -13,
	UIWeek_3_Examples_imageLayoutNativeItemInfoDark = -14,
	
	UIWeek_3_Examples_imageLayoutNativeItemDisclosure = -15,
	
	UIWeek_3_Examples_imageLayoutNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week_3_Examples_imageLayout instances of
