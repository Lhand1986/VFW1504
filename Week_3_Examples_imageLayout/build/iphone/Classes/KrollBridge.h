...
@interface Week_3_Examples_imageLayoutObject : KrollCoverageObject {
#else
@interface Week_3_Examples_imageLayoutObject : KrollObject {
#endif
@private
...
extern NSString * Week_3_Examples_imageLayout$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week_3_Examples_imageLayoutObject *_week_3_examples_imagelayout;
    KrollObject* console;
	BOOL shutdown;
