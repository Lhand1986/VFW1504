...
//@interface Week_3_Examples_imageLayoutObject : NSObject
//@end

@interface Week_3_Examples_imageLayoutObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week_3_Examples_imageLayoutObject class]])
		{
			for (NSString *key in [[(Week_3_Examples_imageLayoutObject*)o modules] allKeys])
			{
