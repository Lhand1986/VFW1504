...
//Rare exceptions to indicate a bug in the _week_3_examples_imagelayout code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Week_3_Examples_imageLayout proxies.
 */
