 ...
 * to send analytic data that can be viewed on the Week_3_Examples_imageLayout Dashboard.
 *
 * For information on getting started with Week_3_Examples_imageLayout Platform Services,
