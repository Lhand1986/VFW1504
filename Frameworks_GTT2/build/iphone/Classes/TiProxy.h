...
//Rare exceptions to indicate a bug in the _frameworks_gtt2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Frameworks_GTT2 proxies.
 */
