...
@interface Frameworks_GTT2Object : KrollCoverageObject {
#else
@interface Frameworks_GTT2Object : KrollObject {
#endif
@private
...
extern NSString * Frameworks_GTT2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Frameworks_GTT2Object *_frameworks_gtt2;
    KrollObject* console;
	BOOL shutdown;
