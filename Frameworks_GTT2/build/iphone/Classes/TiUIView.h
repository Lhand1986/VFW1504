...
/**
 Base class for all Frameworks_GTT2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Frameworks_GTT2 view hierarchy (such as wrapped iOS UIViews) was touched.
