...
/**
 The base class for all Frameworks_GTT2 modules
 */
...
/**
 Frameworks_GTT2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Frameworks_GTT2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Frameworks_GTT2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Frameworks_GTT2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Frameworks_GTT2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
