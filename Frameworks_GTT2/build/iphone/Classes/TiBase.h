...
// in simulator we redefine to format for Frameworks_GTT2 Developer console
...
{\
	NSString * exceptionName = [@"org.frameworks_gtt2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.frameworks_gtt2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFrameworks_GTT2NativeItemNone = -1, 
	UIFrameworks_GTT2NativeItemSpinner = -2,
	UIFrameworks_GTT2NativeItemProgressBar = -3,
	
	UIFrameworks_GTT2NativeItemSlider = -4,
	UIFrameworks_GTT2NativeItemSwitch = -5,
	UIFrameworks_GTT2NativeItemMultiButton = -6,
	UIFrameworks_GTT2NativeItemSegmented = -7,
	
	UIFrameworks_GTT2NativeItemTextView = -8,
	UIFrameworks_GTT2NativeItemTextField = -9,
	UIFrameworks_GTT2NativeItemSearchBar = -10,
	
	UIFrameworks_GTT2NativeItemPicker = -11,
	UIFrameworks_GTT2NativeItemDatePicker = -12,
	
	UIFrameworks_GTT2NativeItemInfoLight = -13,
	UIFrameworks_GTT2NativeItemInfoDark = -14,
	
	UIFrameworks_GTT2NativeItemDisclosure = -15,
	
	UIFrameworks_GTT2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Frameworks_GTT2 instances of
