...
//@interface Frameworks_GTT2Object : NSObject
//@end

@interface Frameworks_GTT2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Frameworks_GTT2Object class]])
		{
			for (NSString *key in [[(Frameworks_GTT2Object*)o modules] allKeys])
			{
