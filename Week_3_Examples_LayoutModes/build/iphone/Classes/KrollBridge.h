...
@interface Week_3_Examples_LayoutModesObject : KrollCoverageObject {
#else
@interface Week_3_Examples_LayoutModesObject : KrollObject {
#endif
@private
...
extern NSString * Week_3_Examples_LayoutModes$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week_3_Examples_LayoutModesObject *_week_3_examples_layoutmodes;
    KrollObject* console;
	BOOL shutdown;
