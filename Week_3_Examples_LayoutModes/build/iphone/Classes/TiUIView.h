...
/**
 Base class for all Week_3_Examples_LayoutModes views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week_3_Examples_LayoutModes view hierarchy (such as wrapped iOS UIViews) was touched.
