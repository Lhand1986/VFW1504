 ...
 * to send analytic data that can be viewed on the Week_3_Examples_LayoutModes Dashboard.
 *
 * For information on getting started with Week_3_Examples_LayoutModes Platform Services,
