...
// in simulator we redefine to format for Week_3_Examples_LayoutModes Developer console
...
{\
	NSString * exceptionName = [@"org.week_3_examples_layoutmodes." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week_3_examples_layoutmodes";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek_3_Examples_LayoutModesNativeItemNone = -1, 
	UIWeek_3_Examples_LayoutModesNativeItemSpinner = -2,
	UIWeek_3_Examples_LayoutModesNativeItemProgressBar = -3,
	
	UIWeek_3_Examples_LayoutModesNativeItemSlider = -4,
	UIWeek_3_Examples_LayoutModesNativeItemSwitch = -5,
	UIWeek_3_Examples_LayoutModesNativeItemMultiButton = -6,
	UIWeek_3_Examples_LayoutModesNativeItemSegmented = -7,
	
	UIWeek_3_Examples_LayoutModesNativeItemTextView = -8,
	UIWeek_3_Examples_LayoutModesNativeItemTextField = -9,
	UIWeek_3_Examples_LayoutModesNativeItemSearchBar = -10,
	
	UIWeek_3_Examples_LayoutModesNativeItemPicker = -11,
	UIWeek_3_Examples_LayoutModesNativeItemDatePicker = -12,
	
	UIWeek_3_Examples_LayoutModesNativeItemInfoLight = -13,
	UIWeek_3_Examples_LayoutModesNativeItemInfoDark = -14,
	
	UIWeek_3_Examples_LayoutModesNativeItemDisclosure = -15,
	
	UIWeek_3_Examples_LayoutModesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week_3_Examples_LayoutModes instances of
