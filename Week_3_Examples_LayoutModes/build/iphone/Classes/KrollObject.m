...
//@interface Week_3_Examples_LayoutModesObject : NSObject
//@end

@interface Week_3_Examples_LayoutModesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week_3_Examples_LayoutModesObject class]])
		{
			for (NSString *key in [[(Week_3_Examples_LayoutModesObject*)o modules] allKeys])
			{
