...
// in simulator we redefine to format for Hand_Levi_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.hand_levi_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hand_levi_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHand_Levi_Project2NativeItemNone = -1, 
	UIHand_Levi_Project2NativeItemSpinner = -2,
	UIHand_Levi_Project2NativeItemProgressBar = -3,
	
	UIHand_Levi_Project2NativeItemSlider = -4,
	UIHand_Levi_Project2NativeItemSwitch = -5,
	UIHand_Levi_Project2NativeItemMultiButton = -6,
	UIHand_Levi_Project2NativeItemSegmented = -7,
	
	UIHand_Levi_Project2NativeItemTextView = -8,
	UIHand_Levi_Project2NativeItemTextField = -9,
	UIHand_Levi_Project2NativeItemSearchBar = -10,
	
	UIHand_Levi_Project2NativeItemPicker = -11,
	UIHand_Levi_Project2NativeItemDatePicker = -12,
	
	UIHand_Levi_Project2NativeItemInfoLight = -13,
	UIHand_Levi_Project2NativeItemInfoDark = -14,
	
	UIHand_Levi_Project2NativeItemDisclosure = -15,
	
	UIHand_Levi_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hand_Levi_Project2 instances of
