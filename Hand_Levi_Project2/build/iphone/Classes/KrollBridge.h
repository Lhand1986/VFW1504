...
@interface Hand_Levi_Project2Object : KrollCoverageObject {
#else
@interface Hand_Levi_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Hand_Levi_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hand_Levi_Project2Object *_hand_levi_project2;
    KrollObject* console;
	BOOL shutdown;
