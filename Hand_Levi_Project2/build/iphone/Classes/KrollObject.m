...
//@interface Hand_Levi_Project2Object : NSObject
//@end

@interface Hand_Levi_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hand_Levi_Project2Object class]])
		{
			for (NSString *key in [[(Hand_Levi_Project2Object*)o modules] allKeys])
			{
