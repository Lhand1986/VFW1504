...
@interface GTT2_ExampleObject : KrollCoverageObject {
#else
@interface GTT2_ExampleObject : KrollObject {
#endif
@private
...
extern NSString * GTT2_Example$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GTT2_ExampleObject *_gtt2_example;
    KrollObject* console;
	BOOL shutdown;
