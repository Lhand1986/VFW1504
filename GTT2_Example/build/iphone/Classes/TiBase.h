...
// in simulator we redefine to format for GTT2_Example Developer console
...
{\
	NSString * exceptionName = [@"org.gtt2_example." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gtt2_example";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGTT2_ExampleNativeItemNone = -1, 
	UIGTT2_ExampleNativeItemSpinner = -2,
	UIGTT2_ExampleNativeItemProgressBar = -3,
	
	UIGTT2_ExampleNativeItemSlider = -4,
	UIGTT2_ExampleNativeItemSwitch = -5,
	UIGTT2_ExampleNativeItemMultiButton = -6,
	UIGTT2_ExampleNativeItemSegmented = -7,
	
	UIGTT2_ExampleNativeItemTextView = -8,
	UIGTT2_ExampleNativeItemTextField = -9,
	UIGTT2_ExampleNativeItemSearchBar = -10,
	
	UIGTT2_ExampleNativeItemPicker = -11,
	UIGTT2_ExampleNativeItemDatePicker = -12,
	
	UIGTT2_ExampleNativeItemInfoLight = -13,
	UIGTT2_ExampleNativeItemInfoDark = -14,
	
	UIGTT2_ExampleNativeItemDisclosure = -15,
	
	UIGTT2_ExampleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GTT2_Example instances of
