...
/**
 Base class for all GTT2_Example views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GTT2_Example view hierarchy (such as wrapped iOS UIViews) was touched.
