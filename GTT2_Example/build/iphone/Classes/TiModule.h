...
/**
 The base class for all GTT2_Example modules
 */
...
/**
 GTT2_Example Platform calls this method on startup.
 */
-(void)startup;

/**
 GTT2_Example Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 GTT2_Example Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 GTT2_Example Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 GTT2_Example Platform calls this method on resume.
 @param sender The sender of the event.
 */
