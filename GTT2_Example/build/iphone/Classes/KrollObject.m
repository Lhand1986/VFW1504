...
//@interface GTT2_ExampleObject : NSObject
//@end

@interface GTT2_ExampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GTT2_ExampleObject class]])
		{
			for (NSString *key in [[(GTT2_ExampleObject*)o modules] allKeys])
			{
