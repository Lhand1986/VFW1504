...
//Rare exceptions to indicate a bug in the _gtt2_example code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GTT2_Example proxies.
 */
